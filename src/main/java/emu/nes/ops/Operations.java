...
public class Operations {
    ...
    private static final Operation NOC = new NoOPCrossing();
    ...
    private static final Operation LAX = new LoadAccumulatorX();
    private static final Operation SAX = new StoreAccumulatorX();
    private static final Operation DCP = new DecrementCompare();
    private static final Operation ISC = new IncrementSubtract();
    private static final Operation SLO = new ShiftLeftOr();
    private static final Operation RLA = new RotateLeftAnd();
    private static final Operation SRE = new ShiftRightExclusiveOr();
    private static final Operation RRA = new RotateRightAddCarry();
